...
type CallFunctionOnParams struct {
	...
	SerializationOptions *SerializationOptions `json:"serializationOptions,omitempty"` // Specifies the result serialization. If provided, overrides returnByValue and generateWebDriverValue.
}
...
// overrides returnByValue and generateWebDriverValue.
