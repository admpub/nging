	...
	for !in.IsDelim('}') {
		...
		case "expressions":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v55 *MediaQueryExpression
					if in.IsNull() {
						in.Skip()
						v55 = nil
					} else {
						if v55 == nil {
							v55 = new(MediaQueryExpression)
						}
						(*v55).UnmarshalEasyJSON(in)
					}
					out.Expressions = append(out.Expressions, v55)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss42(out *jwriter.Writer, in MediaQuery) {
	...
	_ = first
	{
		...
		if in.Expressions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v56, v57 := range in.Expressions {
				if v56 > 0 {
					out.RawByte(',')
				}
				if v57 == nil {
		...
		case "mediaList":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MediaList = append(out.MediaList, v58)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss43(out *jwriter.Writer, in Media) {
	...
	if len(in.MediaList) != 0 {
		...
		{
			out.RawByte('[')
			for v59, v60 := range in.MediaList {
				if v59 > 0 {
					out.RawByte(',')
				}
				if v60 == nil {
		...
		case "subLayers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.SubLayers = append(out.SubLayers, v61)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss44(out *jwriter.Writer, in LayerData) {
	...
	if len(in.SubLayers) != 0 {
		...
		{
			out.RawByte('[')
			for v62, v63 := range in.SubLayers {
				if v62 > 0 {
					out.RawByte(',')
				}
				if v63 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "keyframes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v64 *KeyframeRule
					if in.IsNull() {
						in.Skip()
						v64 = nil
					} else {
						if v64 == nil {
							v64 = new(KeyframeRule)
						}
						(*v64).UnmarshalEasyJSON(in)
					}
					out.Keyframes = append(out.Keyframes, v64)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss46(out *jwriter.Writer, in KeyframesRule) {
	...
	}
	{
		...
		if in.Keyframes == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v65, v66 := range in.Keyframes {
				if v65 > 0 {
					out.RawByte(',')
				}
				if v66 == nil {
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss48(out *jwriter.Writer, in InheritedStyleEntry) {
	...
	}
	{
		...
		if in.MatchedCSSRules == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v68, v69 := range in.MatchedCSSRules {
				if v68 > 0 {
					out.RawByte(',')
				}
				if v69 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "pseudoElements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v70 *PseudoElementMatches
					if in.IsNull() {
						in.Skip()
						v70 = nil
					} else {
						if v70 == nil {
							v70 = new(PseudoElementMatches)
						}
						(*v70).UnmarshalEasyJSON(in)
					}
					out.PseudoElements = append(out.PseudoElements, v70)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss49(out *jwriter.Writer, in InheritedPseudoElementMatches) {
	...
	_ = first
	{
		...
		if in.PseudoElements == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v71, v72 := range in.PseudoElements {
				if v71 > 0 {
					out.RawByte(',')
				}
				if v72 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "fonts":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v73 *PlatformFontUsage
					if in.IsNull() {
						in.Skip()
						v73 = nil
					} else {
						if v73 == nil {
							v73 = new(PlatformFontUsage)
						}
						(*v73).UnmarshalEasyJSON(in)
					}
					out.Fonts = append(out.Fonts, v73)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "medias":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Medias = append(out.Medias, v76)
					in.WantComma()
				}
				in.Delim(']')
			}
	...
	for !in.IsDelim('}') {
		...
		case "matchedCSSRules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MatchedCSSRules = append(out.MatchedCSSRules, v79)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "pseudoElements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v80 *PseudoElementMatches
					if in.IsNull() {
						in.Skip()
						v80 = nil
					} else {
						if v80 == nil {
							v80 = new(PseudoElementMatches)
						}
						(*v80).UnmarshalEasyJSON(in)
					}
					out.PseudoElements = append(out.PseudoElements, v80)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "inherited":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v81 *InheritedStyleEntry
					if in.IsNull() {
						in.Skip()
						v81 = nil
					} else {
						if v81 == nil {
							v81 = new(InheritedStyleEntry)
						}
						(*v81).UnmarshalEasyJSON(in)
					}
					out.Inherited = append(out.Inherited, v81)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "inheritedPseudoElements":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v82 *InheritedPseudoElementMatches
					if in.IsNull() {
						in.Skip()
						v82 = nil
					} else {
						if v82 == nil {
							v82 = new(InheritedPseudoElementMatches)
						}
						(*v82).UnmarshalEasyJSON(in)
					}
					out.InheritedPseudoElements = append(out.InheritedPseudoElements, v82)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "cssKeyframesRules":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v83 *KeyframesRule
					if in.IsNull() {
						in.Skip()
						v83 = nil
					} else {
						if v83 == nil {
							v83 = new(KeyframesRule)
						}
						(*v83).UnmarshalEasyJSON(in)
					}
					out.CSSKeyframesRules = append(out.CSSKeyframesRules, v83)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss56(out *jwriter.Writer, in GetMatchedStylesForNodeReturns) {
	...
	if len(in.MatchedCSSRules) != 0 {
		...
		{
			out.RawByte('[')
			for v84, v85 := range in.MatchedCSSRules {
				if v84 > 0 {
					out.RawByte(',')
				}
				if v85 == nil {
	...
	if len(in.PseudoElements) != 0 {
		...
		{
			out.RawByte('[')
			for v86, v87 := range in.PseudoElements {
				if v86 > 0 {
					out.RawByte(',')
				}
				if v87 == nil {
	...
	if len(in.Inherited) != 0 {
		...
		{
			out.RawByte('[')
			for v88, v89 := range in.Inherited {
				if v88 > 0 {
					out.RawByte(',')
				}
				if v89 == nil {
	...
	if len(in.InheritedPseudoElements) != 0 {
		...
		{
			out.RawByte('[')
			for v90, v91 := range in.InheritedPseudoElements {
				if v90 > 0 {
					out.RawByte(',')
				}
				if v91 == nil {
	...
	if len(in.CSSKeyframesRules) != 0 {
		...
		{
			out.RawByte('[')
			for v92, v93 := range in.CSSKeyframesRules {
				if v92 > 0 {
					out.RawByte(',')
				}
				if v93 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "computedStyle":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v94 *ComputedStyleProperty
					if in.IsNull() {
						in.Skip()
						v94 = nil
					} else {
						if v94 == nil {
							v94 = new(ComputedStyleProperty)
						}
						(*v94).UnmarshalEasyJSON(in)
					}
					out.ComputedStyle = append(out.ComputedStyle, v94)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss62(out *jwriter.Writer, in GetComputedStyleForNodeReturns) {
	...
	if len(in.ComputedStyle) != 0 {
		...
		{
			out.RawByte('[')
			for v95, v96 := range in.ComputedStyle {
				if v95 > 0 {
					out.RawByte(',')
				}
				if v96 == nil {
		...
		case "backgroundColors":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.BackgroundColors = append(out.BackgroundColors, v97)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss64(out *jwriter.Writer, in GetBackgroundColorsReturns) {
	...
	if len(in.BackgroundColors) != 0 {
		...
		{
			out.RawByte('[')
			for v98, v99 := range in.BackgroundColors {
				if v98 > 0 {
					out.RawByte(',')
				}
		...
		case "forcedPseudoClasses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ForcedPseudoClasses = append(out.ForcedPseudoClasses, v100)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss66(out *jwriter.Writer, in ForcePseudoStateParams) {
	...
	}
	{
		...
		if in.ForcedPseudoClasses == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v101, v102 := range in.ForcedPseudoClasses {
				if v101 > 0 {
					out.RawByte(',')
				}
	...
	for !in.IsDelim('}') {
		...
		case "fontVariationAxes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v103 *FontVariationAxis
					if in.IsNull() {
						in.Skip()
						v103 = nil
					} else {
						if v103 == nil {
							v103 = new(FontVariationAxis)
						}
						(*v103).UnmarshalEasyJSON(in)
					}
					out.FontVariationAxes = append(out.FontVariationAxes, v103)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss68(out *jwriter.Writer, in FontFace) {
	...
	if len(in.FontVariationAxes) != 0 {
		...
		{
			out.RawByte('[')
			for v104, v105 := range in.FontVariationAxes {
				if v104 > 0 {
					out.RawByte(',')
				}
				if v105 == nil {
		...
		case "classNames":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.ClassNames = append(out.ClassNames, v106)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonC5a4559bEncodeGithubComChromedpCdprotoCss80(out *jwriter.Writer, in CollectClassNamesReturns) {
	...
	if len(in.ClassNames) != 0 {
		...
		{
			out.RawByte('[')
			for v107, v108 := range in.ClassNames {
				if v107 > 0 {
					out.RawByte(',')
				}
