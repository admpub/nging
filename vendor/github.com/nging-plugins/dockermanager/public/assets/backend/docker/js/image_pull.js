...
function pull(a,ref,url,data){
	if(url==null)url=BACKEND_URL+'/docker/base/image/pull';
	var id=$(a).data('id')||'0';
	...
	var postData={ref:ref,id:id,clientID:App.clientID['notify']};
