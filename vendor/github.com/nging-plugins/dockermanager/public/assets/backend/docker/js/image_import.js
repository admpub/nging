function recv_notice_dockerImageImport(m){
...
function imageImport(data){
	var $form=$('#formImageImport');
...
$(function(){
$('#formImageImport').on('submit',function(e){
    e.preventDefault();
    imageImport({});
})
...
$('#formImageImport').find('input[name="contentFrom"]').on('click',function(){
    switch(this.value){
    case 'input': 
		c('#contentInput',true);
		c('#contentFile',false);
