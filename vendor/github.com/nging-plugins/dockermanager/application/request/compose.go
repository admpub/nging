...
func (c *ComposeAdd) BeforeValidate(ctx echo.Context) error {
...
func (c *ComposeAdd) AfterValidate(ctx echo.Context) error {
...
func (c *ComposeEdit) BeforeValidate(ctx echo.Context) error {
	c.WorkDir = strings.TrimSpace(c.WorkDir)
	return nil
}
