...
func (a *NgingDbSync) Editx(mw func(db.Result) db.Result, args ...interface{}) (affected int64, err error) {
	a.Updated = int(time.Now().Unix())
	if !a.base.Eventable() {
...
func (a *NgingDbSync) EditByFields(mw func(db.Result) db.Result, fields []string, args ...interface{}) (err error) {
	a.Updated = int(time.Now().Unix())
	if !a.base.Eventable() {
...
func (a *NgingDbSync) EditxByFields(mw func(db.Result) db.Result, fields []string, args ...interface{}) (affected int64, err error) {
	a.Updated = int(time.Now().Unix())
	if !a.base.Eventable() {
