...
require (
	...
	github.com/nging-plugins/caddymanager v1.3.4
	...
	github.com/nging-plugins/ftpmanager v1.3.5
	github.com/nging-plugins/servermanager v1.3.2
...
require (
	...
	github.com/go-acme/lego/v4 v4.12.0 // indirect
