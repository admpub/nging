...
require (
	...
	github.com/nging-plugins/caddymanager v0.5.1
	github.com/nging-plugins/collector v0.5.1
	github.com/nging-plugins/dbmanager v0.5.1
	github.com/nging-plugins/ddnsmanager v0.5.1
	github.com/nging-plugins/dlmanager v0.5.1
	github.com/nging-plugins/frpmanager v0.5.1
	github.com/nging-plugins/ftpmanager v0.5.1
	github.com/nging-plugins/servermanager v0.5.1
