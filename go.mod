...
replace github.com/caddyserver/caddy => github.com/caddyserver/caddy v1.0.5
...
require (
	...
	github.com/admpub/mysql-schema-sync v0.0.0-20180407151113-b331d00c7088
	...
	github.com/webx-top/db v1.0.5
	github.com/webx-top/echo v2.1.8+incompatible
