    ...
    NanoScroll = (function() {
      ...
      */
      ...
      NanoScroll.prototype.generate = function() {
        var options, paneClass, sliderClass;
      ...
      */
      ...
      //[SWH|+]
      NanoScroll.prototype.paneShow = function() {
        if (BROWSER_SCROLLBAR_WIDTH) {
          var cssRule = {
            right: -BROWSER_SCROLLBAR_WIDTH
          };
          if(!this.$el.hasClass('has-scrollbar')) this.$el.addClass('has-scrollbar');
          this.$content.css(cssRule);
        }
        this.pane.show();
      };
      //[SWH|+]
      NanoScroll.prototype.paneHide = function() {
        this.pane.hide();
