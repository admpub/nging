   ...
   */
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            search.on('compositionstart', function(e) {
            ...
            search.on("keyup-change input", this.bind(function (e) {
                if(!compositionStart) this.updateResults();
            }));
            search.on("paste", this.bind(this.updateResults));
