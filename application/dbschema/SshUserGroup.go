...
func (this *SshUserGroup) Namer() func(string) string {
	return this.namer
}

func (this *SshUserGroup) CPAFrom(source factory.Model) factory.Model {
...
func (this *SshUserGroup) FromRow(row map[string]interface{}) {
