...
func (this *FrpClient) Namer() func(string) string {
	return this.namer
}

func (this *FrpClient) CPAFrom(source factory.Model) factory.Model {
...
func (this *FrpClient) FromRow(row map[string]interface{}) {
