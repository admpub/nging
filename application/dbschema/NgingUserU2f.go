...
func (a *NgingUserU2f) EditByFields(mw func(db.Result) db.Result, fields []string, args ...interface{}) (err error) {
...
func (a *NgingUserU2f) EditxByFields(mw func(db.Result) db.Result, fields []string, args ...interface{}) (affected int64, err error) {
