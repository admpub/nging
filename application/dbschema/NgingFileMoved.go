...
func (a *NgingFileMoved) SetNamer(namer func(string) string) factory.Model {
	a.base.SetNamer(namer)
	return a
}

func (a *NgingFileMoved) Namer() func(string) string {
	return a.base.Namer()
}
...
func (a *NgingFileMoved) SetFields(mw func(db.Result) db.Result, kvset map[string]interface{}, args ...interface{}) (err error) {
