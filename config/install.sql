...
CREATE TABLE `user` (
  ...
  `file_size` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '上传文件总大小',
  `file_num` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '上传文件数量',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2019-10-27 20:49:43
